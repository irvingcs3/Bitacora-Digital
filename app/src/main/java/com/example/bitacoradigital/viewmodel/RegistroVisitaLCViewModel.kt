// 📁 viewmodel/RegistroVisitaLCViewModel.kt
...
class RegistroVisitaLCViewModel(
    ...
    init {
        viewModelScope.launch {
            invitanteId.value = sessionPrefs.personaId.firstOrNull()
        }
    }
    ...
    // Texto de destino general para Lomas Country
