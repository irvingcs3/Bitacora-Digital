...
@Composable
fun PasoDestinoLC(viewModel: RegistroVisitaViewModel) {
    ...
    Column(
        ...
        OutlinedTextField(
            value = viewModel.destinoLibre.collectAsState().value,
            onValueChange = { viewModel.destinoLibre.value = it },
            label = { Text("Ingrese el destino al que se dirija") },
