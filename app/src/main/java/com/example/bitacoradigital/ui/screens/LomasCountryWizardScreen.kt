// 📁 ui/screens/LomasCountryWizardScreen.kt
...
import com.example.bitacoradigital.ui.screens.lomascountry.PasoConfirmacionLC
import com.example.bitacoradigital.ui.screens.lomascountry.PasoDestinoLC
...
import com.example.bitacoradigital.ui.screens.lomascountry.PasoFinalLC
...
@Composable
fun LomasCountryWizardScreen(perimetroId: Int, navController: NavHostController) {
    ...
    Column(
        ...
        when (pasoActual) {
            ...
            6 -> PasoConfirmacionLC(viewModel, navController)
